    ...
    <Tag {...(isBelowLgScreen && { className: 'flex flex-col' })}>
      <Typography
        ...
        className={classnames('flex items-center gap-2 font-medium plb-3 pli-1.5 hover:text-primary', {
          'text-primary':
            pathname.pathname === '/front-pages/payment' ||
            pathname.pathname === '/front-pages/pricing' ||
            pathname.pathname === '/front-pages/checkout' ||
            pathname.pathname === '/front-pages/help-center' ||
            pathname.pathname === '/front-pages/help-center/article/how-to-add-product-in-cart'
        })}
        {...(isBelowLgScreen
          ? {
