...
import maternityExtendedLeave from '../asset/logo/icons8-crying-baby-64.png'
import parentalLeave from '../asset/logo/icons8-man-feeding-baby-48.png'
...
const getImgLeaveType = (leaveTypeId: number) => {
  switch (leaveTypeId) {
    ...
    case 26:
      return <img src={maternityExtendedLeave} alt='' width={28} />
    case 27:
      return <img src={parentalLeave} alt='' width={28} />
    default:
