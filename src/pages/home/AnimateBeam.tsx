...
export function AnimatedBeamMultipleOutputDemo({ className }: { className?: string }) {
  ...
  return (
    <Card
      className={cn(
        'relative flex h-[350px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl bg-primaryLighter',
        className
      )}
      ref={containerRef}
    >
      <div className='flex size-full flex-row items-stretch justify-between gap-10 max-w-lg'>
        <div className='flex flex-col justify-center gap-2'>
          <Circle ref={div1Ref}>
            {/* <Icons.googleDrive /> */}
            <CustomAvatar skin='light' size={40} color='primary'>
      ...
      <AnimatedBeam containerRef={containerRef} fromRef={div8Ref} toRef={div6Ref} />
    </Card>
  )
}
