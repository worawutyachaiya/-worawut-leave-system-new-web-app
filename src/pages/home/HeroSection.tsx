...
const HeroSection = ({ mode }: { mode: SystemMode }) => {
  ...
  return (
    <section id='home' className='overflow-hidden pbs-[30px] -mbs-[75px] relative'>
      <div className={classnames('pbs-[88px] overflow-hidden', frontCommonStyles.layoutSpacing)}>
        <div className='md:max-is-[550px] mbs-0 mbe-2 mli-auto text-center relative'>
          <Typography
            className={classnames('font-extrabold sm:text-[42px] text-3xl mbe-4 leading-[48px]', styles.heroText)}
          >
            {process.env.NEXT_PUBLIC_APPLICATION_NAME?.toLocaleUpperCase()}
          </Typography>
          <Typography className='font-medium' color='text.primary'>
            ROAD TO SMART FACTORY BE INNOVATIVE, CREATIVE AND PROFITABLE BE AN EXCELLENT COMPANY IN ONE FURUKAWA
          </Typography>
