...
import { PREFIX_QUERY_KEY_TABLE_SEARCH } from '@/_workspace/react-query/hooks/useCheckSubordinateLeave'
import { MENU_ID } from '../env'
import type { FormDataPage } from '../validationSchema'

function SubordinateSearchFilters() {
  ...
  const onSubmit: SubmitHandler<FormDataPage> = () => {
    ...
    queryClient.invalidateQueries({ queryKey: [PREFIX_QUERY_KEY_TABLE_SEARCH] })
    saveUserSettings()
  }
...
export default SubordinateSearchFilters
