...
import TimeRecordCheckerSearchFilter from './TimeRecordCheckerSearchFilter'
import TimeRecordCheckerSearchResult from './TimeRecordCheckerSearchResult'
  ...
  return (
    <Grid container spacing={6}>
      <FormProvider {...reactHookFormMethods}>
        ...
        <Grid item xs={12}>
          {isLoadingReactHookForm ? <SkeletonCustom /> : <TimeRecordCheckerSearchFilter />}
        </Grid>
        <Grid item xs={12}>
          {isLoadingReactHookForm ? <SkeletonCustom /> : <TimeRecordCheckerSearchResult />}
        </Grid>
      </FormProvider>
    </Grid>
  )
