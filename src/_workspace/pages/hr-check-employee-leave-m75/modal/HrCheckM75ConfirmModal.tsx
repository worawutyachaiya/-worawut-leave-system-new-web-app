...
interface HrCheckM75ConfirmModalProps {
    open: boolean
    onClose: () => void
    onConfirm: () => void
    isLoading: boolean
...
const HrCheckM75ConfirmModal = ({ open, onClose, onConfirm, isLoading, selectedCount }: HrCheckM75ConfirmModalProps) => {
            ...
            <DialogContent sx={{ py: 4, px: 5 }}>
                <Box sx={{ textAlign: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography variant='h5' sx={{ color: 'text.secondary', mb: 4 }}>
                        {t('Are you sure you want to check')} {selectedCount} {t('M75 items?')}
                    </Typography>
...
export default HrCheckM75ConfirmModal
