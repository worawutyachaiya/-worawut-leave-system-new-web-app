...
const searchFiltersSchema = z.object({
  ...
  employeeInfo: z
    ...
    .nullable(),
  // HR Check Table search filters
  tableEmployeeCode: z.any().nullable(),
  tableStartDate: z.any().nullable().optional(),
  tableEndDate: z.any().nullable().optional()
})
