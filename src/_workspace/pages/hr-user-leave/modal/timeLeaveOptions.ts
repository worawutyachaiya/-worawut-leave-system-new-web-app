...
export const oneDayTimeLeaveArrWithFlexTimeTypeFaster: TimeLeaveOption[] = [
  { value: '07.30-12.00', label: '07.30 น. - 12.00 น. (0.5 วัน)' },
  { value: '13.00-16.30', label: '13.00 น. - 16.30 น. (0.5 วัน)' },
  { value: '07.30-16.30', label: '07.30 น. - 16.30 น. (1 วัน)' }
]

// เวลาลาสำหรับ Flex Time แบบสาย (09.30-18.30)
export const oneDayTimeLeaveArrWithFlexTimeTypeSlower: TimeLeaveOption[] = [
  { value: '09.30-12.00', label: '09.30 น. - 12.00 น. (0.5 วัน)' },
  { value: '13.00-18.30', label: '13.00 น. - 18.30 น. (0.5 วัน)' },
  { value: '09.30-18.30', label: '09.30 น. - 18.30 น. (1 วัน)' }
]

// เวลาลาสำหรับ M2L (Leave Type ID: 6)
export const timeLeaveArrM2L: TimeLeaveOption[] = [
  { value: '08.30-17.30', label: '08.30 น. - 17.30 น. (1 วัน)' }
]

// เวลาลาสำหรับ WFH (Leave Type ID: 11)
export const timeLeaveArrWFH: TimeLeaveOption[] = [
  { value: '08.30-17.30', label: '08.30 น. - 17.30 น. (1 วัน)' }
]
