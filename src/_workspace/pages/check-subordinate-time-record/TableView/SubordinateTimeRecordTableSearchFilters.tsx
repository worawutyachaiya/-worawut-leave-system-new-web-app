...
import { CHECK_SUBORDINATE_PREFIX_QUERY_KEY } from '@/_workspace/react-query/hooks/useTimeRecordHistorySearch'
import { MENU_ID } from '../env'
import type { FormDataPage } from '../validationSchema'

function SubordinateTimeRecordTableSearchFilters() {
  ...
  const onSubmit: SubmitHandler<FormDataPage> = () => {
    ...
    queryClient.invalidateQueries({ queryKey: [CHECK_SUBORDINATE_PREFIX_QUERY_KEY] })
    saveUserSettings()
  }
...
export default SubordinateTimeRecordTableSearchFilters
