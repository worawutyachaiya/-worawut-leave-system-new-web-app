...
import TimeRecordApprovalSearchFilter from './TimeRecordApprovalSearchFilter'
import TimeRecordApprovalSearchResult from './TimeRecordApprovalSearchResult'
    ...
    <>
      <Grid container spacing={6}>
        <FormProvider {...reactHookFormMethods}>
          ...
          <Grid item xs={12}>
            {isLoadingReactHookForm ? <SkeletonCustom /> : <TimeRecordApprovalSearchFilter />}
          </Grid>
          <Grid item xs={12}>
            {isLoadingReactHookForm ? <SkeletonCustom /> : <TimeRecordApprovalSearchResult />}
          </Grid>
        </FormProvider>
      </Grid>
    </>
