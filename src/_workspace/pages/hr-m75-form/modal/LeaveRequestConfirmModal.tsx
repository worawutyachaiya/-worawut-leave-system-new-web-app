...
// Props
interface LeaveRequestConfirmModalProps {
  open: boolean
  onClose: () => void
  onConfirm: () => void
  isLoading?: boolean
...
const LeaveRequestConfirmModal = ({
  open,
  onClose,
  onConfirm,
  isLoading = false
}: LeaveRequestConfirmModalProps) => {
...
export default LeaveRequestConfirmModal
