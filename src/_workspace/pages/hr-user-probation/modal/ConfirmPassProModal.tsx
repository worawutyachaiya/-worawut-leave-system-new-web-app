...
// Props
interface ConfirmPassProModalProps {
    open: boolean
    onClose: () => void
    onConfirm: () => void
    isLoading?: boolean
...
const ConfirmPassProModal = ({
    open,
    onClose,
    onConfirm,
    isLoading = false
}: ConfirmPassProModalProps) => {
            ...
            <DialogContent sx={{ py: 4, px: 5 }}>
                <Box sx={{ textAlign: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography variant="h4" fontWeight="bold" sx={{ mb: 4 }}>
                        ...
                        Are you sure to update this employee's pass pro date?
                    </Typography>
...
export default ConfirmPassProModal
